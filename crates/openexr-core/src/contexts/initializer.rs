...
impl ContextInitializer {
    ...
    pub fn without_error_handler(mut self) -> ContextInitializer {
    ...
    pub fn with_write_function(
        mut self,
        write_function: sys::exr_write_func_ptr_t,
    ) -> Self {
...
impl Default for ContextInitializer {
    fn default() -> Self {
        ContextInitializer {
...
impl From<ContextInitializer> for sys::exr_context_initializer_t {
    fn from(init: ContextInitializer) -> Self {
